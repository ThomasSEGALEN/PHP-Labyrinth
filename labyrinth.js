...
function getLevel() {
  if (document.getElementById("level1").checked) {
    document.getElementById("link").href =
      "./labyrinth_game.php?init=levels/labyrinth_level1.txt";
  } else if (document.getElementById("level2").checked) {
    document.getElementById("link").href =
      "./labyrinth_game.php?init=levels/labyrinth_level2.txt";
  } else if (document.getElementById("level3").checked) {
    document.getElementById("link").href =
      "./labyrinth_game.php?init=levels/labyrinth_level3.txt";
  }
}
